...
export default function MyApp({ Component, pageProps }: AppProps) {
  ...
  return (
    <Providers>
      <Head>
        <title>CBJ-LAUNCHPAD</title>
        <link rel="preconnect" href="https://fonts.googleapis.com" />
        <link href="https://fonts.googleapis.com/css2?family=Roboto&display=swap" rel="stylesheet" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0" />
        <meta name="description" content="CBJ-LAUNCHPAD is the first exclusive launchpad for decentralized fundraising in Boba ecosystem, offering the hottest and innovative projects in a fair, secure, and efficient way." />
        {/* <meta name="keywords" content="CBJ-LAUNCHPAD"/> */}
        <style>
          {`
            :root {
              --header-height: 110px;
